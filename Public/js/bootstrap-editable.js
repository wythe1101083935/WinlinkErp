...
(function ($) {
    ...
    Popup.prototype = {
        ...
        splitOptions: function() {
            ...
            this.formOptions = {};
            /*2018-03-07 09:42:38 汪志虹  输入框创建时td变为可见 Start*/
            //console.log($(this.$element).parent('td'));
            $(this.$element).parent('td').css('overflow','visible');
            /*2018-03-07 09:42:41 汪志虹  输入框创建时td变为可见 End*/
        ...
        renderForm: function() {
            ...
            .on({
                ...
                cancel: $.proxy(function(){ this.hide('cancel');
                    /*2018-03-07 09:42:38 汪志虹  输入框消失时td变为超出隐藏 Start*/
                    $(this.$element).parent('td').css('overflow','hidden');
                    /*2018-03-07 09:42:41 汪志虹  输入框消失时td变为超出隐藏 End*/
        ...
        closeOthers: function(element) {
            $('.editable-open').each(function(i, el){
                ...
                if(ec.options.onblur === 'cancel') {
                    ...
                    /*2018-03-07 09:40:59 汪志虹  输入框消失时td变为超出隐藏 Start*/
                    $el.parent('td').css('overflow','hidden');
                    /*2018-03-07 09:40:59 汪志虹  输入框消失时td变为超出隐藏 End*/
...
(function ($) {
    ...
    **/
    $.fn.editable = function (option) {
        /*2018-03-05 14:20:47 由于是在参数中加入的，所以此处需要进行parse 汪志虹*/
            /*console.log(option);
            if(typeof option == 'string'){
              option  = JSON.parse(option);
            }*/
            if(typeof option.validate == 'string'){
                optionl.validate = eval(option.validate);
            }
        /*2018-03-05 14:20:47 由于是在参数中加入的，所以此处需要进行parse 汪志虹*/
        //console.log(option);
...
(function ($) {
    ...
    $.extend(Select.prototype, {
        ...
        value2htmlFinal: function(value, element) {
            ...
            if(items.length) {
                /*2018-03-07 11:53:41 汪志虹 将下拉列表选中后的显示为value值，而不是text Start*/
                text = items[0].value;
                //text = items[0].text;
                /*2018-03-07 11:53:41 汪志虹 将下拉列表选中后的显示为value值，而不是text End*/
            }
        ...
        */
        ...
        setPosition: function () { 
           ...
           */
            ...
            /*2018-03-05 14:19:40将以下代码注释后无错，没有getcalculatedoffset方法 汪志虹*/
